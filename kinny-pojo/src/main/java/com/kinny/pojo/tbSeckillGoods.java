...
public class tbSeckillGoods implements Serializable {
    ...
    public BigDecimal getCastPrice() {
        return castPrice;
    }

    public void setCastPrice(BigDecimal castPrice) {
    ...
    public boolean equals(Object that) {
        ...
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getCastPrice() == null ? other.getCastPrice() == null : this.getCastPrice().equals(other.getCastPrice()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getCastPrice() == null) ? 0 : getCastPrice().hashCode());
